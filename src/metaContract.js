...
const allowedMetaTransactionKeys = require('./utils').allowedMetaTransactionKeys
...
class MetaContract {
    constructor(addressOrName, contractInterface, signer) {
        ...
        if (MetaSigner.isMetaSigner(signer)) {
            ...
            errors.throwError('invalid p meta signer', errors.INVALID_ARGUMENT, { arg: 'signer', value: signer });
        }
